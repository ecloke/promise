...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { amount: @achievement.amount, description: @achievement.description, location: @achievement.location, party: @achievement.party, source: @achievement.source, status: @achievement.status, timeline: @achievement.timeline, title: @achievement.title } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { amount: @achievement.amount, description: @achievement.description, location: @achievement.location, party: @achievement.party, source: @achievement.source, status: @achievement.status, timeline: @achievement.timeline, title: @achievement.title } }
